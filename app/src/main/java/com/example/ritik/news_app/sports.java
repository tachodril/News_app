...
public class sports extends Fragment {
    public String url="https://newsapi.org/v2/top-headlines?language=en&category=sports&pageSize=35&apiKey=37fb26157b3b48dd80f9ef8a891e1374";
    ListView liste;
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for(int i=0;i<array.length();i++)
                            {
                                ...
                                img_url=currentarticle.getString("urlToImage");}
