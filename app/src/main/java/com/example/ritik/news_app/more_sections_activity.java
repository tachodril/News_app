...
public class more_sections_activity extends AppCompatActivity {

    public String url,qtitle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_frag_e);
        qtitle=getIntent().getExtras().getString("title");
        url="https://newsapi.org/v2/everything?q="+qtitle+"&pageSize=35&apiKey=37fb26157b3b48dd80f9ef8a891e1374";

        qtitle=qtitle.toUpperCase();
        ActionBar actionBar=getSupportActionBar();
        actionBar.setTitle(qtitle);
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle(Html.fromHtml("<font color='#000000' family='Sans-serif'>"+qtitle+"</font>"));
        Drawable backArrow = getResources().getDrawable(R.drawable.ic_arrow_back_black_24dp);
        actionBar.setHomeAsUpIndicator(backArrow);

        liste=findViewById(R.id.list3);
...
//                startActivity(intent);
                ...
                Intent intent=new Intent(more_sections_activity.this,Description.class);
        ...
        stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        myadap=new newslist_adapter(more_sections_activity.this,newslist);
